...
values
  ('00000000-0000-4000-8000-000000000020', '0x1234567890AbCdEf1234567890AbCdEf1234567890', '线长', 'Line leader', true, 0, 40),
...
insert into public.referrals (wallet_address, sponsor_wallet_address, referral_type, status) values
  ('0xAbCdEf1234567890AbCdEf1234567890AbCdEf01', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'shareholder', 'active'),
  ('0x9876543210FeDcBa9876543210FeDcBa98765432', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'shareholder', 'active'),
  ('0x1111222233334444555566667777888899990000', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'partner', 'active')
...
insert into public.team_nodes (
  ...
  ('00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000010', '0x1234567890AbCdEf1234567890AbCdEf1234567890', null, 'V5', 3200, 286400, 3, 48, false),
...
insert into public.multisig_proposals (
  ...
  (
    ...
    '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'pending',
  ...
  (
    ...
    '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'executed',
...
insert into public.multisig_signatures (proposal_id, signer_wallet, signed_at) values
  ('00000000-0000-4000-8000-000000000201', '0x1234567890AbCdEf1234567890AbCdEf1234567890', '2026-07-28 14:20+00'),
  ('00000000-0000-4000-8000-000000000202', '0x1234567890AbCdEf1234567890AbCdEf1234567890', '2026-06-28 10:15+00'),
...
insert into public.dividend_accruals (
  ...
  ('00000000-0000-4000-8000-000000000301', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'fees', 68.2, 'Epoch #42', 'epoch', 'pending', '手续费滑点', 'Trading slippage', now(), now(), null),
  ('00000000-0000-4000-8000-000000000302', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'treasury', 42.6, '2026年7月', 'monthly', 'multisig_pending', '市值管理', 'Treasury yield', now(), now(), '00000000-0000-4000-8000-000000000201'),
  ('00000000-0000-4000-8000-000000000303', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'line', 75.6, '2026年7月本线', 'monthly', 'multisig_pending', '分线手续费 + 贿赂', 'Line fees + bribe', now(), now(), '00000000-0000-4000-8000-000000000201'),
  ('00000000-0000-4000-8000-000000000304', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'd3', 'fees', 4.1, 'Epoch #42', 'epoch', 'pending', '手续费权益 D3', 'Fee equity D3', now(), now(), null),
  ('00000000-0000-4000-8000-000000000305', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'd3', 'treasury', 3.2, '2026年7月', 'monthly', 'multisig_pending', '市值管理 D3', 'Treasury D3', now(), now(), '00000000-0000-4000-8000-000000000201'),
  ('00000000-0000-4000-8000-000000000306', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'd3', 'line', 5.5, '2026年7月本线', 'monthly', 'multisig_pending', '分线排放 D3', 'Line emission D3', now(), now(), '00000000-0000-4000-8000-000000000201'),
  ('00000000-0000-4000-8000-000000000307', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'fees', 98.5, 'Epoch #41', 'epoch', 'claimed', '手续费滑点', 'Trading slippage', '2026-07-06', '2026-07-06', null),
  ('00000000-0000-4000-8000-000000000308', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'line', 43.7, '2026年6月', 'monthly', 'claimed', '分线手续费 + 贿赂', 'Line fees + bribe', '2026-07-01', '2026-07-01', null),
  ('00000000-0000-4000-8000-000000000309', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'd3', 'fees', 9.6, 'Epoch #42', 'epoch', 'claimable', '手续费权益 D3', 'Fee equity D3', '2026-07-07', '2026-07-07', null),
  ('00000000-0000-4000-8000-000000000310', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'd3', 'line', 7.2, '2026年6月', 'monthly', 'claimed', '分线排放 D3', 'Line emission D3', '2026-07-01', '2026-07-01', null),
  ('00000000-0000-4000-8000-000000000311', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'referral', 150, 'Epoch #42', 'epoch', 'claimed', '推荐奖励', 'Referral reward', '2026-07-06', '2026-07-06', null),
  ('00000000-0000-4000-8000-000000000312', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'dynamic', 0, 'Epoch #42', 'epoch', 'none', 'PoC 级差', 'PoC differential', '2026-07-05', '2026-07-05', null),
  ('00000000-0000-4000-8000-000000000313', '0x1234567890AbCdEf1234567890AbCdEf1234567890', 'usd3', 'dynamic', 0, 'Epoch #42', 'epoch', 'none', 'PoN 算力奖', 'PoN bonus', '2026-07-04', '2026-07-04', null)
