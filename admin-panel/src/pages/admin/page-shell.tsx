...
export function PageShell({ title, subtitle, actions, children }: Props) {
  return (
    <div className="px-4 lg:px-8 py-4 lg:py-6 space-y-4 lg:space-y-6">
      <header className="relative flex flex-wrap items-start justify-between gap-x-3 gap-y-3 pb-3 border-b border-border/40">
        ...
        <div className="min-w-0 flex-1 basis-[60%]">
          <h1
            className="text-xl lg:text-3xl font-black tracking-tight break-words"
            style={{
