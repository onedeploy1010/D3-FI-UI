...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: true,
    // NOTE: no manualChunks — hand-splitting vendors here caused a cross-chunk
    // circular init ("Cannot access 'A' before initialization" TDZ crash) in
    // production. Route-level React.lazy splitting is enough; let Rollup decide
