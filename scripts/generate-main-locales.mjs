...
const partnerJa = {
  ...
  'home.benefitsTitle': '入盟特典', 'home.tiersTitle': '反賄賂ティア', 'home.becomePartner': 'パートナーになる',
  'home.becomeDesc': '{fee} USDTの入盟金で配置・反賄賂sD3・チーム機能を解放。',
  'home.goJoin': 'クラウドファンドへ · 申請', 'home.isPartner': 'パートナー有効',
  'benefit.globalTree': '全网配置', 'benefit.price': '5U価格', 'benefit.static': '0.4%静的',
  'benefit.antibribe': '反賄賂支援', 'benefit.investor': '投資家保護', 'benefit.contract': '公開契約',
  ...
  'assets.dailyUsdt': '日次USDT', 'assets.totalSd3': '累計sD3', 'assets.antibribe': '反賄賂',
