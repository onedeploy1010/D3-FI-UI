...
/** Tier thresholds from official chart (小区/引路人业绩 ceilings, inclusive). */
 ...
 * ≤10万 50% · ≤20万 60% · ≤30万 70% · ≤50万 80% · ≤80万 90% · >80万(至100万+) 100%
 * Tier 1 includes 0–100k; higher tiers use (prev, ceiling].
 */
